...
@Component({
  selector: 'app-adddatakh',
  templateUrl: './adddatakh.component.html',
  // styleUrls: ['./adddatakh.component.css']
  styleUrls: [
...
export class AdddatakhComponent {
  ...
  addNewItem(itemData: any): void {
    ...
    this.api.addItemkh(itemData).subscribe(
      result => {
